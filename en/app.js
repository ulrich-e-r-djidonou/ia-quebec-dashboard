// ═══ APP.JS — AI Quebec Interactive Dashboard (English) ═══
...
new Chart(document.getElementById('chartCategories'), {
  ...
  options: {
    ...
    scales: {
      x: { beginAtZero: true, grid: { color: '#F3F4F6' }, title: { display: true, text: 'Number of projects' } },
...
new Chart(document.getElementById('chartCatEvolution'), {
  ...
  options: {
    ...
    plugins: {
      legend: { display: false },
      tooltip: { ...tooltipConfig(), callbacks: { label: ctx => `Change: ${ctx.raw > 0 ? '+' : ''}${ctx.raw} projects` } },
      datalabels: {
    ...
    scales: {
      x: { grid: { color: '#F3F4F6' }, title: { display: true, text: 'Change in number of projects' } },
      y: { grid: { display: false }, ticks: { font: { size: 11 } } }
    }
  },
  plugins: [ChartDataLabels]
...
new Chart(document.getElementById('chartTopOrgs'), {
  ...
  options: {
    ...
    scales: {
      x: { beginAtZero: true, grid: { color: '#F3F4F6' }, title: { display: true, text: 'Number of AI projects' } },
      y: { grid: { display: false }, ticks: { font: { size: 11 } } }
    }
  },
  plugins: [ChartDataLabels]
...
new Chart(document.getElementById('chartProdVsDev'), {
  ...
  data: {
    labels: ['2024', '2025'],
    datasets: [
      { label: 'In Production', data: [DATA.statuts.y2024[0], DATA.statuts.y2025[0]], backgroundColor: GREEN, borderRadius: 6, barPercentage: 0.6 },
      { label: 'In Development', data: [DATA.statuts.y2024[1], DATA.statuts.y2025[1]], backgroundColor: ORANGE, borderRadius: 6, barPercentage: 0.6 },
    ]
  },
  options: {
    responsive: true,
    ...
    scales: {
      y: { beginAtZero: true, grid: { color: '#F3F4F6' }, title: { display: true, text: 'Number of projects' } },
      x: { grid: { display: false }, ticks: { font: { size: 14, weight: '600' } } }
    }
  },
  plugins: [ChartDataLabels]
...
// ═══ CHART 10: NEW ORGANIZATIONS BY SECTOR ═══
